...
import com.ai.aicodemother.model.dto.app.*;
...
import com.ai.aicodemother.ratelimiter.annotation.RateLimit;
import com.ai.aicodemother.ratelimiter.enums.RateLimitType;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page", // 缓存的前缀
            key = "T(com.ai.aicodemother.utils.CacheKeyUtils).getCacheKey(#appQueryRequest)", // 缓存的 key 生成规则
            condition = "#appQueryRequest.getPageNum() <= 10" // 采用缓存的条件
    )
