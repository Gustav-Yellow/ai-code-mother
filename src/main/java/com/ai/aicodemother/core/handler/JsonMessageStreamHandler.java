...
import com.ai.aicodemother.ai.tools.BaseTool;
import com.ai.aicodemother.ai.tools.ToolManager;
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    // 异步构建 Vue 项目，暂时将异步构建 Vue 项目替换成同步构建，因为当前的项目并发量不是特别高，同步能更好地保证实时性
